                    ...
                    <tbody>
                        @foreach ($rentals as $rental)
                            <tr>
                                ...
                                <td>{{ $rental->email }}</td>
                                <td>{{ $rental->status }}</td>
                                <td>{{ date('F j, Y', strtotime($rental->created_at)) }}</td>
                                <td>
                                    <button type="button" class="btn btn-primary editBtn" data-id="{{ $rental->id }}"
                                        data-toggle="modal" data-target="#editModal">Edit</button>
                                    <button type="button" class="btn btn-danger deleteBtn" data-id="{{ $rental->id }}"
